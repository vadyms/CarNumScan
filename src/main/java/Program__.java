...
public class Program__ {
    ...
    static String path = "/home/uadmin/IdeaProjects/NumbersScanner02/src/main/";
...
//        img = Imgcodecs.imread(path+image);
        img = Imgcodecs.imread(path +"changes/st/"+ image, Imgcodecs.CV_LOAD_IMAGE_ANYCOLOR);
...
//        Imgcodecs.imwrite(path+"changes/st/10_imgDetectedPlateTrue.png", imgDetectedPlateTrue);
        ...
        File imageFile = new File(path+"changes/st/10_imgDetectedPlateTrue.png");
